...
function FullScreenDialog({
  ...
  const [values, setValues] = react__WEBPACK_IMPORTED_MODULE_8___default.a.useState({
    firstName: '',
    lastName: '',
    email: ''
  });
  ...
  const handleChange = event => {
    if (currentValues) setValues(_objectSpread({}, values, {
...
//# sourceMappingURL=FormPage.js.4de09b05afead07009fe.hot-update.js.map