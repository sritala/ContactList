...
/* harmony import */ var _services_persons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/persons */ "./src/components/services/persons.tsx");
/* harmony import */ var _PersonForm__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./PersonForm */ "./src/components/ui/PersonForm.tsx");
/* harmony import */ var _Notification__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Notification */ "./src/components/ui/Notification.tsx");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(() => {
    _services_persons__WEBPACK_IMPORTED_MODULE_9__["default"].getAll().then(initialPersons => {
  ...
  const addContact = event => {
    ...
    if (toUpdate.length === 1) {
      ...
      if (confirm) {
        _services_persons__WEBPACK_IMPORTED_MODULE_9__["default"].update(toUpdate[0].id, _objectSpread({}, toUpdate[0], {
          number: newNumber
        })).then(updatedPerson => {
      ...
      _services_persons__WEBPACK_IMPORTED_MODULE_9__["default"].create(personObject).then(returnedNote => {
  ...
  const deletePerson = id => {
    _services_persons__WEBPACK_IMPORTED_MODULE_9__["default"].remove(id).then(() => {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, __jsx(_PersonForm__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    __self: this
  })), __jsx(_Notification__WEBPACK_IMPORTED_MODULE_11__["default"], {
    type: "error",
...
//# sourceMappingURL=AddContact.js.40fe695bc5655b55c547.hot-update.js.map